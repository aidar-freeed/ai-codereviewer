...
public class InstallmentScheduleFragment extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      /*  List<InstallmentSchedule> installmentSchedules= InstallmentScheduleDataAccess.getAll(this, GlobalData.getSharedGlobalData().getUser().getUuid_user());
